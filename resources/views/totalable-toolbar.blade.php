                    ...
                    <div class="col">
                        <div class="card shadow-lg h-100">
                            <div class="card-body rounded p-2 text-truncate d-flex flex-column justify-content-center align-items-center">
                                <h6 class="card-title mb-2 text-center text-truncate">{{ $totalableColumn['title'] }}</h6>
                                <div id="{{ $totalableColumn['alias'] }}" class="d-flex justify-content-center align-items-center">
